...
public class ScUserManagerCondition {
    ...
    public static void checkSQLinjectionException(ScUserManagerCondition condition) {
     ...
     */
    public static boolean checkSQLinjection(ScUserManagerCondition condition) {
