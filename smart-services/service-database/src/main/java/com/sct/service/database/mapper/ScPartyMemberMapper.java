...
public interface ScPartyMemberMapper {
    ...
    public List<ScUser> selectConditionPage(@Param("condition") ScPartyMemberCondition condition, @Param("qPaging") QPaging qPaging);

    public List<ScUser> selectCondition(@Param("condition") ScPartyMemberCondition condition);
}